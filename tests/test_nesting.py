...
def test_a_bare_array_learns_what_it_holds_from_its_description() -> None:
    """An `Array` cell whose description names a structure records that it
    holds objects, the same as it does through an authored anchor. It was an
    array either way; only the element type was unknown."""
